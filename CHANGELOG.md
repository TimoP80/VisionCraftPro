...
### 🐛 Fixed
- **Leonardo.ai FLUX Model Dimension Errors** - Fixed critical 400 Bad Request errors for FLUX.1 Kontext and other FLUX models by implementing automatic dimension validation. The system now automatically selects valid dimension pairs (e.g., 1024×1024, 1440×810) from the model's allowed list instead of using arbitrary aspect ratio dimensions.
